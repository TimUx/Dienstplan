...
class ShiftPlanningSolver:
    ...
    def add_all_constraints(self):
        ...
        team_shift, employee_active, employee_weekend_shift, td_vars, springer_cross_team = self.planning_model.get_variables()
        ...
        add_employee_team_linkage_constraints(model, team_shift, employee_active, springer_cross_team, employees, teams, dates, weeks, shift_codes, absences)
        
        # STAFFING AND WORKING CONDITIONS
        print("  - Staffing requirements (min/max per shift)")
        add_staffing_constraints(model, employee_active, employee_weekend_shift, team_shift, springer_cross_team, employees, teams, dates, weeks, shift_codes)
        ...
        objective_terms = add_fairness_objectives(model, employee_active, employee_weekend_shift, team_shift, td_vars, springer_cross_team, employees, teams, dates, weeks, shift_codes)
