"""
Test mit 44h/Woche und weiter gelockerten Besetzungsanforderungen.
Früh max 12, Spät max 12, Nacht max 4, Wochenende max 3.
"""
...
def test_44h_max_12_12_4_januar_2026():
    """Test mit 44h/Woche und gelockerten Besetzungen (F:12, S:12, N:4)"""
    
    print("=" * 100)
    print("TEST: Januar 2026 mit 44h/Woche + F:Max12, S:Max12, N:Max4, WE:Max3")
    print("=" * 100)
    ...
    shift_types = [
        ...
        ShiftType(
            ...
            min_staff_weekday=2, max_staff_weekday=4,  # Max 4
            min_staff_weekend=2, max_staff_weekend=3,   # Max 3
            works_monday=True, works_tuesday=True, works_wednesday=True,
            works_thursday=True, works_friday=True, works_saturday=True, works_sunday=True
        )
        ...
        if success:
            ...
            for shift_code in ['F', 'S', 'N']:
                ...
                if shift_staffing:
                    ...
                    if shift_code == 'N' and max_staff <= 4:
                        print(f"    ✓ Nacht-Schicht Max=4 wird eingehalten!")
                    elif shift_code == 'N' and max_staff > 4:
                        print(f"    ✗ Nacht-Schicht Max=4 wird NICHT eingehalten! (Max: {max_staff})")
            ...
            print("FAZIT")
            print("=" * 100)
            print("✓ Mit 44h/Woche und gelockerten Besetzungen (F:12, S:12, N:4) IST eine Lösung möglich!")
            ...
            print("✓ Erhöhte Flexibilität bei Früh- und Spät-Schicht ermöglicht Lösung")
            print("=" * 100)
            ...
            print(f"\n{'='*100}")
            print("MÖGLICHE ANPASSUNGEN")
            print("=" * 100)
            print("1. Erhöhe Nacht-Schicht Max auf 5-6")
            print("2. Reduziere Arbeitsstunden auf 42h/Woche")
            print("3. Erhöhe alle Max-Werte weiter (F:15, S:15, N:6)")
            print("=" * 100)
...
if __name__ == "__main__":
    success = test_44h_max_12_12_4_januar_2026()
