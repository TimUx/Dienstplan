"""
Test mit 44h/Woche und Nacht-Schicht Max=4 (Kompromiss).
...
def test_44h_nacht_max4_januar_2026():
    """Test mit 44h/Woche, gelockerte Besetzung, Nacht-Schicht Max=4 (Kompromiss)"""
    
    print("=" * 100)
    print("TEST: Januar 2026 mit 44h/Woche + Nacht Max=4 + Mon-Fri Blocks")
    print("=" * 100)
    
    # Schichttypen mit 44h/Woche und Nacht Max=4
    shift_types = [
        ShiftType(
        ...
        ShiftType(
            ...
            min_staff_weekday=2, max_staff_weekday=4,  # KOMPROMISS: Max 4
    ...
    print(f"      Nacht: Min 2, Max 4 (KOMPROMISS)")
    ...
    try:
        ...
        print(f"\n{'='*100}")
        if success:
            print("✓✓✓ LÖSUNG GEFUNDEN mit 44h/Woche + Nacht Max=4 ✓✓✓")
            ...
            if night_staffing:
                ...
                if max_night <= 4:
                    ...
                    print(f"  ✗ Nacht-Schicht Max=4 wird NICHT eingehalten! (Max: {max_night})")
            ...
            print("FAZIT")
            print("=" * 100)
            print("✓ Mit 44h/Woche und Nacht Max=4 IST eine Lösung möglich!")
            ...
            print("✓ Nacht-Schicht Constraint (Max=4) ermöglicht mehr Flexibilität")
            print("=" * 100)
            
            return True
        else:
            print("✗ INFEASIBLE mit 44h/Woche und Nacht Max=4")
...
if __name__ == "__main__":
    success = test_44h_nacht_max4_januar_2026()
