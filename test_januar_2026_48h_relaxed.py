"""
Test mit 48h/Woche und gelockerten Besetzungsanforderungen.
Nutzt die neuen Mon-Fri Block-Constraints.
"""
...
def test_48h_relaxed_januar_2026():
    """Test mit 48h/Woche und gelockerten Besetzungsanforderungen"""
    
    print("=" * 100)
    print("TEST: Januar 2026 mit 48h/Woche + gelockerte Besetzung + Mon-Fri Blocks")
    print("=" * 100)
    
    # Schichttypen mit 48h/Woche und GELOCKERTEN Besetzungsanforderungen
    shift_types = [
        ShiftType(
    ...
    print(f"  - Arbeitsstunden: 48h/Woche (ORIGINAL)")
    print(f"  - Besetzung: GELOCKERT (Min 2-3, Max 10)")
    ...
    try:
        ...
        print(f"\n{'='*100}")
        if success:
            print("✓✓✓ LÖSUNG GEFUNDEN mit 48h/Woche + gelockerte Besetzung ✓✓✓")
            ...
            print("FAZIT")
            print("=" * 100)
            print("✓ Mit 48h/Woche und gelockerten Besetzungsanforderungen IST eine Lösung möglich!")
            ...
            print("✓ Empfehlung: Diese Konfiguration für Januar 2026 nutzen")
            print("=" * 100)
            
            return True
        else:
            print("✗ INFEASIBLE auch mit gelockerten Besetzungsanforderungen")
...
if __name__ == "__main__":
    success = test_48h_relaxed_januar_2026()
